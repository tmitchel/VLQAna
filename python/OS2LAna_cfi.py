...
ana = cms.EDFilter("OS2LAna",
    ...
    hltreject                  = cms.InputTag("evtrejecter","hltdecision"),
    ...
    tau21Shift                 = cms.int32(0),
    tau32Shift                 = cms.int32(0),
    WZShift                    = cms.int32(0),
    higgsShift                 = cms.int32(0),
    topShift                   = cms.int32(0),
    ...
    File_pTCorr                = cms.string('../data/elpt_SF.root'),
    Hist_pTCorr                = cms.string('elpt_SF'),

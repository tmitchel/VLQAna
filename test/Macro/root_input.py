...
#  INPUTS		
# =====================================================
path = '/uscms_data/d3/tmitchel/OS2L/CMSSW_8_0_20/src/Analysis/VLQAna/test/Macro/rootfiles/Zelel/ARC_v10_1bplots/'
ch = 'CR_Zelel'
...
f_ttZ         = TFile(path+'ttZ.root')
f_ttW         = TFile(path+'ttW.root')
f_tZq         = TFile(path+'tZq.root')
f_ST_twll     = TFile(path+'ST_tWll.root')


f_BpBp_bZbZ_800  = TFile(path+'bprime800_bZbZ.root')
f_BpBp_bZbZ_1000  = TFile(path+'bprime1000_bZbZ.root')
f_BpBp_bZbZ_1200 = TFile(path+'bprime1200_bZbZ.root')
f_BpBp_bZbH_800  = TFile(path+'bprime800_bZbH.root')
f_BpBp_bZbH_1000 = TFile(path+'bprime1000_bZbH.root')
f_BpBp_bZbH_1200 = TFile(path+'bprime1200_bZbH.root')
...
tZq_xs            = 0.0758
twll_xs           = 0.01123
DY100to200_xs     = 83.12   *gSF #* 1.23
DY200to400_xs     = 3.047   *gSF #* 1.23
DY400to600_xs     = 0.3921  *gSF #* 1.23
DY600toInf_xs     = 0.03636 *gSF #* 1.23
...
ttZ_num          =  f_ttZ.Get("allEvents/hEventCount_wt").GetBinContent(1)
ttW_num          =  f_ttW.Get("allEvents/hEventCount_wt").GetBinContent(1)
tZq_num          =  f_tZq.Get("allEvents/hEventCount_wt").GetBinContent(1)
twll_num          =  f_ST_twll.Get("allEvents/hEventCount_wt").GetBinContent(1)
...
DY600toInf_num   =  f_DY600toInf.Get("allEvents/hEventCount_wt").GetBinContent(1)
ZZTo2L2Nu_num    =  f_ZZTo2L2Nu.Get("allEvents/hEventCount_wt").GetBinContent(1)
WZTo2L2Q_num     =  f_WZTo2L2Q.Get("allEvents/hEventCount_wt").GetBinContent(1)
WWTo2L2Nu_num    =  f_WWTo2L2Nu.Get("allEvents/hEventCount_wt").GetBinContent(1)
...
BpBp800_bZbH_num      =  f_BpBp_bZbH_800.Get('ana/signalEvts').GetBinContent(1)
BpBp1000_bH_num     =  f_BpBp_bZbH_1000.Get('ana/signalEvts').GetBinContent(1)
BpBp1200_bZbH_num     =  f_BpBp_bZbH_1200.Get('ana/signalEvts').GetBinContent(1)
...
def setCosmetics(hist, legname, hname, color):
    ...
    elif 'bZbZ' in hname or 'bZbH' in hname:          
        hist.SetLineWidth(2)
